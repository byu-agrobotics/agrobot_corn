...
#include "agrobot_interfaces/srv/detail/move_servo__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agrobot_interfaces::srv::MoveServo_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agrobot_interfaces::srv::MoveServo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<agrobot_interfaces::srv::MoveServo_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_agrobot_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<agrobot_interfaces::srv::MoveServo_Request>()
{
  return &agrobot_interfaces::srv::typesupport_fastrtps_cpp::_MoveServo_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agrobot_interfaces::srv::MoveServo_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agrobot_interfaces::srv::MoveServo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<agrobot_interfaces::srv::MoveServo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &agrobot_interfaces::srv::typesupport_fastrtps_cpp::_MoveServo_Response__handle;
}
...
// functions for agrobot_interfaces::srv::MoveServo_Request already declared above

// functions for agrobot_interfaces::srv::MoveServo_Response already declared above
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      agrobot_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  agrobot_interfaces::srv::MoveServo_Event & ros_message)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      agrobot_interfaces::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        agrobot_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        agrobot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_MoveServo_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        agrobot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_MoveServo_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agrobot_interfaces::srv::MoveServo_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      agrobot_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        agrobot_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        agrobot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_MoveServo_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        agrobot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_MoveServo_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const agrobot_interfaces::srv::MoveServo_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<agrobot_interfaces::srv::MoveServo_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MoveServo_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const agrobot_interfaces::srv::MoveServo_Event *>(
...
static size_t _MoveServo_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MoveServo_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MoveServo_Event__callbacks = {
  "agrobot_interfaces::srv",
  "MoveServo_Event",
...
static rosidl_message_type_support_t _MoveServo_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MoveServo_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &agrobot_interfaces::srv::typesupport_fastrtps_cpp::_MoveServo_Event__handle;
}
...
static const rosidl_service_type_support_t _MoveServo__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MoveServo__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<agrobot_interfaces::srv::MoveServo_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<agrobot_interfaces::srv::MoveServo_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<agrobot_interfaces::srv::MoveServo_Event>(),
...
{
  return &agrobot_interfaces::srv::typesupport_fastrtps_cpp::_MoveServo__handle;
}
