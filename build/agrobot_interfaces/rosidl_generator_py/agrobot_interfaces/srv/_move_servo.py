...
class Metaclass_MoveServo_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('agrobot_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_MoveServo_Event(type):
    """Metaclass of message 'MoveServo_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__move_servo__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__move_servo__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__move_servo__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__move_servo__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__move_servo__event
...
class MoveServo_Event(metaclass=Metaclass_MoveServo_Event):
    """Message class 'MoveServo_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<agrobot_interfaces/MoveServo_Request, 1>',
        'response': 'sequence<agrobot_interfaces/MoveServo_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['agrobot_interfaces', 'srv'], 'MoveServo_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['agrobot_interfaces', 'srv'], 'MoveServo_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from agrobot_interfaces.srv import MoveServo_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, MoveServo_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'MoveServo_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from agrobot_interfaces.srv import MoveServo_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MoveServo_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'MoveServo_Response'"
        self._response = value
...
class Metaclass_MoveServo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'agrobot_interfaces.srv.MoveServo')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from agrobot_interfaces.srv import _move_servo
            ...
            if _move_servo.Metaclass_MoveServo_Event._TYPE_SUPPORT is None:
                _move_servo.Metaclass_MoveServo_Event.__import_type_support__()


class MoveServo(metaclass=Metaclass_MoveServo):
    from agrobot_interfaces.srv._move_servo import MoveServo_Request as Request
    from agrobot_interfaces.srv._move_servo import MoveServo_Response as Response
    from agrobot_interfaces.srv._move_servo import MoveServo_Event as Event
