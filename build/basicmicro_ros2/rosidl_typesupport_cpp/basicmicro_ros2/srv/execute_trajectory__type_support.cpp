...
static const _ExecuteTrajectory_Request_type_support_symbol_names_t _ExecuteTrajectory_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, ExecuteTrajectory_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, ExecuteTrajectory_Request)),
  }
};
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::ExecuteTrajectory_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, ExecuteTrajectory_Request)() {
  return get_message_type_support_handle<basicmicro_ros2::srv::ExecuteTrajectory_Request>();
}
...
static const _ExecuteTrajectory_Response_type_support_symbol_names_t _ExecuteTrajectory_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, ExecuteTrajectory_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, ExecuteTrajectory_Response)),
  }
};
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::ExecuteTrajectory_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, ExecuteTrajectory_Response)() {
  return get_message_type_support_handle<basicmicro_ros2::srv::ExecuteTrajectory_Response>();
}
...
static const _ExecuteTrajectory_Event_type_support_symbol_names_t _ExecuteTrajectory_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, ExecuteTrajectory_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, ExecuteTrajectory_Event)),
  }
};
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::ExecuteTrajectory_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, ExecuteTrajectory_Event)() {
  return get_message_type_support_handle<basicmicro_ros2::srv::ExecuteTrajectory_Event>();
}
...
static const _ExecuteTrajectory_type_support_symbol_names_t _ExecuteTrajectory_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, ExecuteTrajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, ExecuteTrajectory)),
  }
};
...
static const rosidl_service_type_support_t ExecuteTrajectory_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<basicmicro_ros2::srv::ExecuteTrajectory_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<basicmicro_ros2::srv::ExecuteTrajectory_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<basicmicro_ros2::srv::ExecuteTrajectory_Event>(),
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::ExecuteTrajectory_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, ExecuteTrajectory)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<basicmicro_ros2::srv::ExecuteTrajectory>();
}
