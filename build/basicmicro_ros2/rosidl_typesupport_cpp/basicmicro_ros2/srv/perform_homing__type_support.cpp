...
static const _PerformHoming_Request_type_support_symbol_names_t _PerformHoming_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, PerformHoming_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, PerformHoming_Request)),
  }
};
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::PerformHoming_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, PerformHoming_Request)() {
  return get_message_type_support_handle<basicmicro_ros2::srv::PerformHoming_Request>();
}
...
static const _PerformHoming_Response_type_support_symbol_names_t _PerformHoming_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, PerformHoming_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, PerformHoming_Response)),
  }
};
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::PerformHoming_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, PerformHoming_Response)() {
  return get_message_type_support_handle<basicmicro_ros2::srv::PerformHoming_Response>();
}
...
static const _PerformHoming_Event_type_support_symbol_names_t _PerformHoming_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, PerformHoming_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, PerformHoming_Event)),
  }
};
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::PerformHoming_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, PerformHoming_Event)() {
  return get_message_type_support_handle<basicmicro_ros2::srv::PerformHoming_Event>();
}
...
static const _PerformHoming_type_support_symbol_names_t _PerformHoming_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, PerformHoming)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, PerformHoming)),
  }
};
...
static const rosidl_service_type_support_t PerformHoming_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<basicmicro_ros2::srv::PerformHoming_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<basicmicro_ros2::srv::PerformHoming_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<basicmicro_ros2::srv::PerformHoming_Event>(),
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::PerformHoming_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, PerformHoming)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<basicmicro_ros2::srv::PerformHoming>();
}
