...
static const _SetMotionStrategy_Request_type_support_symbol_names_t _SetMotionStrategy_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, SetMotionStrategy_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, SetMotionStrategy_Request)),
  }
};
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::SetMotionStrategy_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, SetMotionStrategy_Request)() {
  return get_message_type_support_handle<basicmicro_ros2::srv::SetMotionStrategy_Request>();
}
...
static const _SetMotionStrategy_Response_type_support_symbol_names_t _SetMotionStrategy_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, SetMotionStrategy_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, SetMotionStrategy_Response)),
  }
};
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::SetMotionStrategy_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, SetMotionStrategy_Response)() {
  return get_message_type_support_handle<basicmicro_ros2::srv::SetMotionStrategy_Response>();
}
...
static const _SetMotionStrategy_Event_type_support_symbol_names_t _SetMotionStrategy_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, SetMotionStrategy_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, SetMotionStrategy_Event)),
  }
};
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::SetMotionStrategy_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, SetMotionStrategy_Event)() {
  return get_message_type_support_handle<basicmicro_ros2::srv::SetMotionStrategy_Event>();
}
...
static const _SetMotionStrategy_type_support_symbol_names_t _SetMotionStrategy_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, srv, SetMotionStrategy)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, srv, SetMotionStrategy)),
  }
};
...
static const rosidl_service_type_support_t SetMotionStrategy_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<basicmicro_ros2::srv::SetMotionStrategy_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<basicmicro_ros2::srv::SetMotionStrategy_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<basicmicro_ros2::srv::SetMotionStrategy_Event>(),
...
{
  return &::basicmicro_ros2::srv::rosidl_typesupport_cpp::SetMotionStrategy_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, srv, SetMotionStrategy)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<basicmicro_ros2::srv::SetMotionStrategy>();
}
