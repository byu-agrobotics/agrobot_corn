...
static const _PositionPoint_type_support_symbol_names_t _PositionPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, msg, PositionPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, basicmicro_ros2, msg, PositionPoint)),
  }
};
...
{
  return &::basicmicro_ros2::msg::rosidl_typesupport_cpp::PositionPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, basicmicro_ros2, msg, PositionPoint)() {
  return get_message_type_support_handle<basicmicro_ros2::msg::PositionPoint>();
}
