...
#include "basicmicro_ros2/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const basicmicro_ros2::msg::TrajectoryPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  basicmicro_ros2::msg::TrajectoryPoint & ros_message)
{
  // Member: command_type
  cdr >> ros_message.command_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = basicmicro_ros2::msg::TrajectoryPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const basicmicro_ros2::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<basicmicro_ros2::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  return &basicmicro_ros2::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, basicmicro_ros2, msg, TrajectoryPoint)() {
  return &basicmicro_ros2::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
