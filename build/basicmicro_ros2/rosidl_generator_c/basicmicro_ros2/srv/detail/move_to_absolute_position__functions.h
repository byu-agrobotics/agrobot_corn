...
#ifndef BASICMICRO_ROS2__SRV__DETAIL__MOVE_TO_ABSOLUTE_POSITION__FUNCTIONS_H_
#define BASICMICRO_ROS2__SRV__DETAIL__MOVE_TO_ABSOLUTE_POSITION__FUNCTIONS_H_
...
/// Initialize srv/MoveToAbsolutePosition message.
/**
 ...
 * )) before or use
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Request__create()
...
/// Finalize srv/MoveToAbsolutePosition message.
/**
...
/// Create srv/MoveToAbsolutePosition message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Request__init().
...
/// Destroy srv/MoveToAbsolutePosition message.
/**
 * It calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Request__fini()
...
/// Check for srv/MoveToAbsolutePosition message equality.
/**
...
/// Copy a srv/MoveToAbsolutePosition message.
/**
...
/// Initialize array of srv/MoveToAbsolutePosition messages.
/**
...
/// Finalize array of srv/MoveToAbsolutePosition messages.
/**
 * It calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Request__fini()
...
/// Create array of srv/MoveToAbsolutePosition messages.
/**
 * It allocates the memory for the array and calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MoveToAbsolutePosition messages.
/**
 * It calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MoveToAbsolutePosition message array equality.
/**
...
/// Copy an array of srv/MoveToAbsolutePosition messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_basicmicro_ros2
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_basicmicro_ros2
...
/**
 * It calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_basicmicro_ros2
...
/**
 * It allocates the memory for the array and calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_basicmicro_ros2
...
/**
 * It calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_basicmicro_ros2
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_basicmicro_ros2
...
/**
 * It calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_basicmicro_ros2
...
/**
 * It allocates the memory for the array and calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_basicmicro_ros2
...
/**
 * It calls
 * basicmicro_ros2__srv__MoveToAbsolutePosition_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BASICMICRO_ROS2__SRV__DETAIL__MOVE_TO_ABSOLUTE_POSITION__FUNCTIONS_H_
