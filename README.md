...
> **NOTE:** Newer Macs that use ARM64 architecture (M1, M2, etc) may experience missing package support and have not been extensively tested.
...
- Open a WSL terminal and clone the agrobot_2.0 repo into your WSL environment using `git clone https://github.com/byu-agrobotics/agrobot_2.0.git`.
