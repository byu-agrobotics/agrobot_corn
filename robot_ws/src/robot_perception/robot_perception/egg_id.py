...
from robot_interfaces.srv import IdentifyEgg
import cv2
import numpy as np
import threading
...
class EggID(Node):
    ...
    Services:
        - egg/identify (robot_interfaces/srv/IdentifyEgg)
    """
    ...
    def egg_id_callback(self, request, response):
        ...
        :type request: robot_interfaces.srv.IdentifyEgg.Request
        :param response: Response message
        :type response: robot_interfaces.srv.IdentifyEgg.Response
        """
